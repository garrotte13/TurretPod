...
script.on_event(defines.events.on_runtime_mod_setting_changed, function(e)
  if e.setting == "zd-AllowChangeAmmo" then storage.reloadP.AllowChangeAmmo = settings.global["zd-AllowChangeAmmo"].value end
  --game.print("Auto ammunition reset setting was changed!")
end)

script.on_event(defines.events.on_tick, function(event)
  reloadP.EveryTick(storage.reloadPods.equipped_weapon_id, game.ticks_played)
